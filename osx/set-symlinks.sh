...
# Set a Symlink in the $HOME/Dropbox/Tasks TaskPaper Tasks folder
echo -e "Set a Symlink in the \$HOME/Dropbox/Tasks TaskPaper Tasks folder \n"
ln -sf ~/Library/Mobile\ Documents/com~hogbaysoftware~TaskPaper/Documents ~/Dropbox/Tasks
